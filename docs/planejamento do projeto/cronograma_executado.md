...
Este documento representa o registro detalhado e cronológico das ações e tarefas realizadas ao longo de um período determinado. Nele, você encontrará uma apresentação minuciosa das atividades que foram planejadas e executadas com sucesso, refletindo o comprometimento e a dedicação da nossa equipe na busca dos nossos objetivos.
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>Início: 06/set <br> Fim: 07/set</td>
      <td>Início: 06/set <br> Fim: 07/set</td>
    ...
    <tr>
      ...
      <td>Início: 06/set <br> Fim: 13/set</td>
      <td>Início: 06/set <br> Fim: 11/set</td>
      <td><a href="https://github.com/GZaranza">Gabriel Zaranza</a></td>
      <td>Início: 13/set <br> Fim:14/set</td>
      <td>Início: 13/set <br> Fim:14/set</td>
      <td><a href="https://github.com/izabellaalves">Izabella Alves</a></td>
    ...
    <tr>
      ...
      <td>Início: 06/set <br> Fim: 13/set</td>
      <td>Início: 06/set <br> Fim: 20/set</td>
      <td><a href="https://github.com/izabellaalves">Izabella Alves</a></td>
      <td>Início: 13/set <br> Fim:14/set</td>
      <td>Início: 21/set <br> Fim:22/set</td>
      <td><a href="https://github.com/lucassouzs">Lucas Ribeiro</a></td>
    </tr>
    <tr>
      <td>Gravação 1</td>
...
<div align="center">
<font size="3"><p style="text-align: center"><b>Tabela 2</b> - Cronograma executado para a etapa de Elicitação</p></font>
...
Na tabela 3 encontram-se as datas do cronograma executado para a etapa de Modelagem de Requisitos.

<div align="center">
<font size="3"><p style="text-align: center"><b>Tabela 3</b> - Cronograma executado para a etapa de Elicitação</p></font>
...
| :----: | ---------- | ------------------------------------------------ | ----------------------------------------------------------------------------------------------------- | :--------------------------------------------: |
| `1.0`  | 15/09/2023 | Criação do cronograma.                           | [Zenilda Vieira](https://github.com/ZenildaVieira) <br> [Gabriel Rosa](https://github.com/gabrielrosa09) | [Gabriel Zaranza](https://github.com/GZaranza) |
...
| `1.7`  | 03/12/2023 | Inclusão das datas da entrega 5.2                   | [Zenilda Vieira](https://github.com/ZenildaVieira)                                                    |[Gabriel Rosa](https://github.com/gabrielrosa09)|