# Protótipo de Alta Fidelidade - Emitir Segunda Via da Dívida Ativa
...
Na figura 1, é possível ver o protótipo de alta fidelidade feito para o requisito "Emitir Segunda Via da Dívida Ativa".
...
A avaliação foi conduzida pela integrante do grupo [Izabella Alves](https://github.com/izabellaalves) e contou com a participação da entrevistada, Elaime Rodrigues. Não houve outras pessoas envolvidas no processo, e a avaliação foi realizada dentro do orçamento planejado, sem custos adicionais. Os equipamentos utilizados um notebook, um mouse e dois celulares para gravação do áudio e dos vídeos da entrevista.
...
<p style="text-align: center"><a href="https://youtu.be/4MLMQnLlVNg" target="blanket"><b>Vídeo 1:</b> Validação do Protótipo "Emitir Segunda Via da Dívida Ativa"</a></p>

<iframe width="560" height="315" src="https://www.youtube.com/embed/4MLMQnLlVNg" title="Apresentação 7" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
...
| :----: | ---------- | -------------------- | :------------------------------------------------: | :----------------------------------------------: |
| `1.0`  | 27/11/2023 |  Criação do documento |  [Izabella Alves](https://github.com/izabellaalves)    |  [Gabriel Zaranza](https://github.com/GZaranza)|
