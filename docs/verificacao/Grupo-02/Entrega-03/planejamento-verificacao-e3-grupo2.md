...
Os checklists criados se baseiam nos critérios estabelecidos no Plano de Ensino da disciplina Requisitos de Softawre [1], bem como na observação dos projetos dos semestres anteriores e dos feedbacks dados pelos monitores e pelo Professor após as apresentações.
