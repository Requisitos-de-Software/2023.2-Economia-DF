# Verificação do Artefato "Glossário"

## Introdução

Este documento apresenta os resultados da inspeção realizada no artefato "[Glossário](https://github.com/Requisitos-de-Software/2023.2-Carteira_Digital_de_Transito/blob/main/docs/elicita%C3%A7%C3%A3o/glossario.md)", desenvolvido pelo [Grupo 2](https://requisitos-de-software.github.io/2023.2-Carteira_Digital_de_Transito/) como parte da disciplina de Requisitos de Software. A versão objeto de análise é a 1.2, datada de 22/10/2023, conforme registrada no histórico de versões.
...
<div align="center">
<font size="3"><p style="text-align: center"><b>Tabela 2:</b> Checklist Glossário</p></font>
...
- **ID 07**: Os requisitos não foram classificados corretamente, indicando a necessidade de revisão e correção no processo de classificação.
...
>
> CARTEIRA DIGITAL DE TRÂNSITO. [Glossário](https://github.com/Requisitos-de-Software/2023.2-Carteira_Digital_de_Transito/blob/main/docs/elicita%C3%A7%C3%A3o/glossario.md), FGA, GAMA, 2023. Acesso em: 10 de novembro de 2023.
