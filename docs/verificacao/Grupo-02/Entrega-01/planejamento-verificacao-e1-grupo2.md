...
## Introdução
Este documento apresenta o planejamento da verificação dos artefatos produzidos pelo [Grupo 02](https://requisitos-de-software.github.io/2023.2-Carteira_Digital_de_Transito/) durante a Etapa 1 - Planejamento do projeto.
## Objetivos
...
<tbody>
    ...
    <tr>
        <td>  10/10/2023 </td>
        <td>  Verificação do artefato "Cronograma" </td>
        <td> 	<a href="https://github.com/GZaranza">Gabriel Zaranza</a> </td>
    </tr>
    <tr>
        <td>  10/10/2023 </td>
        <td>  Verificação do artefato "Aplicativos" </td>
        <td> 	<a href="https://github.com/GZaranza">Gabriel Zaranza</a> </td>
    </tr>
    <tr>
        <td>  10/10/2023 </td>
