# Verificação do artefato "First Thing First"
...
<div align="center">
<font size="3"><p style="text-align: center"><b>Tabela 2:</b> Checklist para o artefato de First Thing First</p></font>
...
Nesta seção, serão apresentados os resultados obtidos na verificação do artefato "[First Things First](https://github.com/Requisitos-de-Software/2023.2-Economia-DF/blob/main/docs/elicitacao/tecnicas-priorizacao/first-thing-first.md)" na forma de um gráfico de pizza, onde são apresentadas a quantidade de "sim", "não", "incompleto" e "não se aplica" obtidos na verificação.

### Checklist Geral

No Gráfico 1, é possível visualizar os resultados obtidos na verificação do artefato "[First Things First](https://github.com/Requisitos-de-Software/2023.2-Economia-DF/blob/main/docs/elicitacao/tecnicas-priorizacao/first-thing-first.md)" em relação ao checklist geral.
...
No Gráfico 2, é possível visualizar os resultados obtidos na verificação do artefato "[First Things First](https://github.com/Requisitos-de-Software/2023.2-Economia-DF/blob/main/docs/elicitacao/tecnicas-priorizacao/first-thing-first.md)" em relação ao checklist específico.
